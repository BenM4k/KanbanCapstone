...
<div align="center">
  <h3><b>Show Streaming Web Page</b></h3>
...
**Show Streaming Web Page:** Show Streaming Web Page is a collaborative project developed by two individuals, offering a user-friendly platform for streaming shows. With features like user likes and comment functionality, it provides an engaging and interactive experience. Our progress was effectively tracked using a Kanban board, ensuring efficient development and seamless collaboration.
...
- [x] **Single Page App**
- [x] **Likes and comments functionality**
...
```
   ssh code:
   git@github.com:BenM4k/KanbanCapstone.git
```
...
```
  cd desired-folder
  git clone git@github.com:BenM4k/KanbanCapstone.git
```
